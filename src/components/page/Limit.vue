        ...
        <el-form ref="form" :model="form" label-width="100px" style="">
          <table style="width:100%; padding:0 10%">
            <tr>
              <td>
                <el-form-item label="工坊号">
                  <el-input v-model="form.Sid" disabled="disabled" class="width-input"></el-input>
                </el-form-item>
              </td>
              <td>
                <el-form-item label="工坊名称">
                  <el-input v-model="form.Factoryname" class="width-input"></el-input>
                </el-form-item>
              </td>
            </tr>
            <tr>
              <td>
                <el-form-item label="额定人数">
                  <el-input v-model="form.Stationnum" class="width-input"></el-input>
                </el-form-item>
              </td>
              <td>
                <el-form-item label="房间数目">
                  <el-input-number
            ...
            <tr>
              ...
              <td>
                <el-form-item label="房间额定人数">
                  <el-input-number
                    v-model="form.RoomPersonNum"
                    @change="handleChangePersonNum"
                    :min="0"
                    label="房间额定人数"
                    class="width-input"
                  ></el-input-number>
            ...
            <tr>
              <td>
                <el-form-item label="工位地址">
                  <el-input v-model="form.Station" class="width-input"></el-input>
                </el-form-item>
              </td>
              <td>
                <el-form-item label="工坊说明">
                  <el-input v-model="form.Stationexplain" class="width-input"></el-input>
                </el-form-item>
              </td>
            </tr>
            <tr>
...
<script>
import { getFactoryBySid, postFactory } from "./../../api/api";
export default {
  data: function() {
    return {
      form: {
  ...
  methods: {
    ...
    handleChangeRoomnum(value) {
      if (value > this.Rooms.length) {
        ...
        this.$confirm(
          '您正在做删除操作，当点击页面中"提交"按钮时执行该操作，是否继续？',
          "提示",
          {
